...
ActiveRecord::Schema.define(version: 2020_10_08_023413) do
  ...
  create_table "restaurant_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "cafe_restaurant_id"
    t.string "image"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cafe_restaurant_id"], name: "index_restaurant_images_on_cafe_restaurant_id"
  end
